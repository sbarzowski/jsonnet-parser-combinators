...
&& std.assertEqual([[null, null], null], pc.runParser(pc.parseSeq([pc.parseConst("aaa"), pc.parseConst("bbb")]), "aaabbb"))
&& std.assertEqual([[null, null], null], pc.runParser(pc.parseSeq(["aaa", "bbb"]), "aaabbb"))
...
&& std.assertEqual([[null, null], null], pc.runParser(pc.parseSeq([pc.parseGreedy("a"), "b"]), "aaaaaab"))
